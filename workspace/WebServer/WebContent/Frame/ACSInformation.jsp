			...
			<div class="span2  col-xs-12 col-sm-3 col-md-2">
				<ul class="nav nav-pills nav-stacked demo-nav side-bar">
					...
					<li><a href="device_message.jsp" id="device_message"><span
							...
							设备消息 </a></li>
					<li class="active"><a href="ACSInformation.jsp"
					...
					<table class="table  table-striped table-bordered " id="table">
						...
						<tbody>
							...
							<tr>
								...
								<td><input id="<%=i.getID()%>" type="checkbox" checked></td>
<script>
if("<%=i.getStatus()%>"=="1")
	$('#<%=i.getID()%>').bootstrapSwitch("state", true);
else
	$('#<%=i.getID()%>').bootstrapSwitch("state", false);
	   ...
	   var sta=1;
	   	if(state!=true)
	   		sta=0;
	   			...
	   			$.post("/WebServer/Frame/ACS_change.jsp", {
	   				"ask" : "change",
	   				"id" : "<%=i.getID()%>",
					"sta" : sta,
